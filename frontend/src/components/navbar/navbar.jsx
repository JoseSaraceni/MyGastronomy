...
export default function Navbar() {
    ...
    return(
        ...
        <nav className={styles.navbarContainer}>
            ...
            {/* Container icones da barra do topo*/}

            <div className={styles.navbarItems}>
                <img className={styles.logo} src="/logo.png" alt="Logo do Site" />

                {/* Container icones da barra do topo*/}

                <div className={styles.navbarLinksContainer}>

                    <a href="" className={styles.navbarLink}Home>Home</a>
                    <a href="" className={styles.navbarLink}Plates>Plates</a>
